...
public class RagedThugAI : MonoBehaviour
{
    public bool isEnraged = false;
    public bool isHighOnDrugs = false;
    public float highOnDrugsShootRate = 1.2f;
    public GameObject[] chems;
    public GameObject[] summonableAI;
    public float ragedDistanceFromPlayer = 3f;
    public float normalDistanceFromPlayer = 10f;
